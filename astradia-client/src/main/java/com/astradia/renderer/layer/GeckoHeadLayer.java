...
public class GeckoHeadLayer<T extends LivingEntity & GeoAnimatable, O, R extends AvatarRenderState & GeoRenderState>  extends GeoRenderLayer<T, O, R> {
    public GeckoHeadLayer(GeoRenderer<T, O, R> renderer) {
        super(renderer);
    }
